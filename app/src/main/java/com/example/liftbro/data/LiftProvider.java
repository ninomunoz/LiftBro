...
public class LiftProvider extends ContentProvider {
    ...
    private LiftDatabase mDatabase = null;

    static {
        mUriMatcher.addURI(LiftContract.CONTENT_AUTHORITY, MuscleGroupEntry.TABLE_NAME, MUSCLE_GROUPS);
        mUriMatcher.addURI(LiftContract.CONTENT_AUTHORITY, MuscleGroupEntry.TABLE_NAME + "/#", MUSCLE_GROUP_ID);
        mUriMatcher.addURI(LiftContract.CONTENT_AUTHORITY, WorkoutEntry.TABLE_NAME, WORKOUTS);
        mUriMatcher.addURI(LiftContract.CONTENT_AUTHORITY, WorkoutEntry.TABLE_NAME + "/#", WORKOUT_ID);
        mUriMatcher.addURI(LiftContract.CONTENT_AUTHORITY, ExerciseEntry.TABLE_NAME, EXERCISES);
        mUriMatcher.addURI(LiftContract.CONTENT_AUTHORITY, ExerciseEntry.TABLE_NAME + "/#", EXERCISE_ID);
        mUriMatcher.addURI(LiftContract.CONTENT_AUTHORITY, WorkoutExerciseEntry.TABLE_NAME, WORKOUT_EXERCISES);
        mUriMatcher.addURI(LiftContract.CONTENT_AUTHORITY, WorkoutExerciseEntry.TABLE_NAME + "/#", WORKOUT_EXERCISE_ID);
    }

    @Override
    public boolean onCreate() {
        mDatabase = new LiftDatabase(getContext());
        return true;
    }
